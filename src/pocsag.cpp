...
namespace CelebWeather
{
    namespace Pocsag
    {
        ...
        const unsigned char LUT_ByteBitsInverter[10] = {};
        const unsigned char LUT_QuartetBitsInverter[10] = {};
...
*/
        ...
        int GetBits(unsigned char* frame, size_t frameSize)
        {
            ...
            int batchesCount = 0; //set_alphanum_frame((poc_batch *)&batches, MAXBATCHCNT-1, ric, func&3, (char*)frame, frameSize);
